...
<div class="table-responsive-sm">
  <table class="table table-striped table-sm" style="font-size: 14px;">
    ...
    <th scope="col" style="border:none" width="10%">TECNICO</th>
...
<td style="border:none"></td>
            ...
            <?php   
                while($cliente = mysqli_fetch_assoc($clientes)){
					...
					$aparelho_box = $cliente['aparelho_box'];
					$fonte_box = $cliente['fonte_box'];
					$cabo_hdmi = $cliente['cabo_hdmi'];
					$controle_box = $cliente['controle_box'];
					$fonte_box_cabo = $cliente['fonte_box_cabo'];
					$conversor_hdmi = $cliente['conversor_hdmi'];
					$conclusao = $cliente['conclusao'];
					
					?>
<tr>
            <td> <?php echo $cliente['id_tvbox']?></td>
            ...
            <td><?php echo $cliente['situacao']?></td>
				 <td><?php echo $cliente['status']?><?php
$status = $status;
...
<strong>CLIENTE:</strong> <?php echo $cliente['nome']?> <br>
...
{
$d = "$cabo_hdmi CABO HDMI\n";
}

echo $d;
?>
<?php
$controle_box = $controle_box;
...
{
$e = "$controle_box CONTROLE \n";
}

echo $e;
?>
<?php
$fonte_box_cabo = $fonte_box_cabo;
...
{
$f = "$fonte_box_cabo FONTE BOX COM CABO\n";
}

echo $f;
?>
<?php
$conversor_hdmi = $conversor_hdmi;
...
{
$g = "$conversor_hdmi CONVERSOR HDMI\n";
}

echo $g;
?>

<strong>CONCLUIDO:</strong> <?php echo date('d/m/y - H:i', strtotime($cliente['ultima_alteracao']))?>  <br>
...
*ORDEM DE SERVIÇO Nº <?php echo $cliente['id_tvbox']?> CONCLUIDA*

*TÉCNICO RESPONSAVEL:* <?php echo$cliente['tecnico']?> 
*VEÍCULO:* <?php echo $cliente['veiculo']?> 

*CLIENTE:* <?php echo $cliente['nome']?> 
*PPPOE:* <?php echo $cliente['pppoe']?> 
*REDE:* <?php echo $cliente['rede']?> 
*SENHA:*  <?php echo $cliente['redesenha']?> 
*SINAL IXC:* <?php echo $cliente['sinal']?> 

*SITUAÇÃO:* <?php echo $cliente['conclusao']?> 
...
*TEMPO DE CHAMADO:* <?php echo $cliente['tempo']?> 
