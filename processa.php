...
echo '
      <form method="POST" action="processa_cad_clientes.php">
        <div class="row">
          <div class="col-md-7 col-sm-12">
            <label for="recipient-nome" class="col-form-label" >NOME:</label>
            <input value="'.$razao.'" style="text-transform: uppercase;" type="text" name="nome" id="nome" maxlength="50" class="form-control">
          </div>
       
        <div class="col-md-5 col-sm-12">
            <label for="recipient-situacao" class="col-form-label">SITUAÇÃO:</label>
            <select class="form-select" name="situacao" id="recipient-situacao" aria-label=".form-select-lg example">
              <option value="CLIENTE SEM ACESSO">CLIENTE SEM ACESSO</option>
              <option value="TROCA DE SENHA">TROCA DE SENHA</option>
              <option value="TROCA DE ROTEADOR">TROCA DE ROTEADOR</option>
              <option value="DROP ROMPIDO">DROP ROMPIDO</option>
              <option value="ALTERAR EQUIPAMENTO DE LOCAL">ALTERAR EQUIPAMENTO DE LOCAL</option>
              <option value="VERIFICAR CONEXAO">VERIFICAR CONEXAO</option>
              <option value="PUXAR REPETIDOR">PUXAR REPETIDOR</option>
              <option value="MIGRAÇÃO DE PLANO">MIGRAÇÃO DE PLANO</option>       
              <option value="REPARO INTERNO">REPARO INTERNO</option>              
              <option value="REPARO EXTERNO">REPARO EXTERNO</option>
            </select>
          </div>
           </div>
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12">
            ...
            <textarea class="form-control" style="text-transform: uppercase;" name="observacao" id="recipient-observacao"  aria-label="With textarea"></textarea>
          </div>        

          <div class="col-md-5 col-sm-12">
            <label for="recipient-bairro" class="col-form-label">BAIRRO:</label>
            <input value="'.$bairro.'" type="text" style="text-transform: uppercase;" name="bairro" id="recipient-bairro" maxlength="50" class="form-control -10">
          </div>
          <div class="col-md-5 col-sm-12">
            <label for="recipient-rua" class="col-form-label">RUA:</label>
            <input value="'.$endereco.'" style="text-transform: uppercase;" type="text" name="rua" id="rua" maxlength="50" class="form-control -10">
          </div>
          ...
          <div class="col-md-4 col-sm-12">
            <label for="recipient-onu" class="col-form-label">ONU/ONT:</label>
            <input type="text" name="onu" id="onu" class="form-control" value="'.$onu_tipo.'" >
          </div>
          ...
          <div class="col-md-4 col-sm-12">
            ...
            <input class="w3-input w3-border form-control " value="'.date('Y-m-d').'" type="date"  name="agendado" id="agendado" required>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4 col-sm-12">
