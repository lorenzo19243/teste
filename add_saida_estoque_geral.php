...
$dataLocal = date('d/m/Y H:i:s', time());
    ...
    $query = "UPDATE hb_estoque_geral set quantidade = quantidade - '$qtd_formatada' WHERE  produto ='$produto_saida'";
    $log_categoria = "INSERT INTO hb_logs_estoque_geral set log='SAIDA DE $qtd_formatada $produto_saida DO ESTOQUE!', motivo='$motivo', data='$data_cadastro', utilizador='$alterado_por'";
