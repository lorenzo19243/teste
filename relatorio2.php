...
<button type="button" class="btn btn-sm btn-dark " data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#cadCliente">NOVO CHAMADO</button>
        ...
        <div class="col-md-4 bg-warning  justify-content-between p-3 d-flex"><input type="text" name="pesquisa_cliente" id="pesquisa_cliente" class="form-control" placeholder="PESQUISAR CLIENTES POR NOME" required autofocus>
...
<table class="table" style="font-size: 12px;">
  ...
  <tbody>
    <tr>
      ...
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="01" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d REPAROS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="02" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d REPAROS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="03" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d REPAROS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="04" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d REPAROS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="05" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d REPAROS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="06" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d REPAROS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="07" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d REPAROS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="08" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d REPAROS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="09" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d REPAROS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="10" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d REPAROS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="11" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d REPAROS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE MONTH(data_fim)="12" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d REPAROS", $row_cnt);				
 ?></td>
      <td> <?php $clientes = mysqli_query($conn,'SELECT * FROM clientes WHERE YEAR(data_fim)="2024" AND concluido="SIM" ORDER BY nome DESC;');
...
<tr>
      ...
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="01" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d INSTAL.", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="02" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d INSTAL.", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="03" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d INSTAL.", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="04" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d INSTAL.", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="05" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d INSTAL.", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="06" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d INSTAL.", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="07" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d INSTAL.", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="08" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d INSTAL.", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="09" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d INSTAL.", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="10" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d INSTAL.", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="11" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d INSTAL.", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE MONTH(data_fim)="12" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d INSTAL.", $row_cnt);				
 ?></td>
      <td> <?php $clientes = mysqli_query($conn,'SELECT * FROM instalacoes WHERE YEAR(data_fim)="2024" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d MUDANÇAS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM mudanca WHERE MONTH(data_fim)="09" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d MUDANÇAS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM mudanca WHERE MONTH(data_fim)="10" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d MUDANÇAS", $row_cnt);				
 ?></td>
      <td> <?php $clientes = mysqli_query($conn,'SELECT * FROM mudanca WHERE YEAR(data_fim)="2024" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d RECOLHAS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM recolhas WHERE MONTH(data_fim)="09" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d RECOLHAS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM recolhas WHERE MONTH(data_fim)="10" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d RECOLHAS", $row_cnt);				
 ?></td>
      <td> <?php $clientes = mysqli_query($conn,'SELECT * FROM recolhas WHERE YEAR(data_fim)="2024" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d", $row_cnt);				
 ?></td>
      <td><strong><?php $result=mysqli_query($conn, 'SELECT (SELECT COUNT(*) FROM clientes WHERE MONTH(data_fim)="09" AND concluido="SIM") +
    (SELECT COUNT(*) FROM instalacoes WHERE MONTH(data_fim)="09" AND concluido="SIM") +
    (SELECT COUNT(*) FROM mudanca WHERE MONTH(data_fim)="09" AND concluido="SIM") +
    (SELECT COUNT(*) FROM recolhas WHERE MONTH(data_fim)="09" AND concluido="SIM") AS total;');
	
$data=mysqli_fetch_assoc($result);
echo $data['total']; ?></strong></td>
      <td><strong><?php $result=mysqli_query($conn, 'SELECT (SELECT COUNT(*) FROM clientes WHERE MONTH(data_fim)="10" AND concluido="SIM") +
    (SELECT COUNT(*) FROM instalacoes WHERE MONTH(data_fim)="10" AND concluido="SIM") +
    (SELECT COUNT(*) FROM mudanca WHERE MONTH(data_fim)="10" AND concluido="SIM") +
    (SELECT COUNT(*) FROM recolhas WHERE MONTH(data_fim)="10" AND concluido="SIM") AS total;');
	
$data=mysqli_fetch_assoc($result);
echo $data['total']; ?></strong></td>
      <td><strong><?php $result=mysqli_query($conn, 'SELECT (SELECT COUNT(*) FROM clientes WHERE MONTH(data_fim)="11" AND concluido="SIM") +
    (SELECT COUNT(*) FROM instalacoes WHERE MONTH(data_fim)="11" AND concluido="SIM") +
    (SELECT COUNT(*) FROM mudanca WHERE MONTH(data_fim)="11" AND concluido="SIM") +
    (SELECT COUNT(*) FROM recolhas WHERE MONTH(data_fim)="11" AND concluido="SIM") AS total;');
	
$data=mysqli_fetch_assoc($result);
echo $data['total']; ?></strong></td>
      <td><strong><?php $result=mysqli_query($conn, 'SELECT (SELECT COUNT(*) FROM clientes WHERE MONTH(data_fim)="12" AND concluido="SIM") +
    (SELECT COUNT(*) FROM instalacoes WHERE MONTH(data_fim)="12" AND concluido="SIM") +
    (SELECT COUNT(*) FROM mudanca WHERE MONTH(data_fim)="12" AND concluido="SIM") +
    (SELECT COUNT(*) FROM recolhas WHERE MONTH(data_fim)="12" AND concluido="SIM") AS total;');
	
$data=mysqli_fetch_assoc($result);
echo $data['total']; ?></strong></td>
      <td><strong><?php $result=mysqli_query($conn, "SELECT (SELECT COUNT(*) FROM clientes WHERE concluido = 'SIM') +
...
printf("%d MUDAN.", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM mudanca WHERE MONTH(data_fim)="11" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d RECOL.", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM recolhas WHERE MONTH(data_fim)="11" AND concluido="SIM" ORDER BY nome DESC;');
