...
<?php include_once('assets/menu.php'); ?>
 <?php  
 include('config/conexao.php');
 $query ="SELECT * FROM hb_logs_estoque_frenteloja ORDER BY id ASC";  
...
<div class="p-4 p-md-12 mb-4 rounded text-body-emphasis bg-body-secondary">
  <div class="col-lg-4 col-md-12 mx-auto">
        <h1 class="fw-light">MOV ESTOQUE LOJA</h1>
        </p>
      </div>              
 </div> 
  ...
  <?php  
 include('config/conexao.php');
 $query ="SELECT * FROM hb_logs_estoque_frenteloja LIMIT 3000;";  
 $result = mysqli_query($conn, $query);  
 ?>       
