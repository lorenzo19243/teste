...
seguranca_adm();
$hoje = date("Y-m-d");
$consulta = 'SELECT * FROM recolhas WHERE  STATUS="ANDAMENTO"  
union 
(SELECT * FROM recolhas WHERE  STATUS="REMARCAR" )
union 
(SELECT * FROM recolhas WHERE  STATUS="DROP" )
union
(SELECT * FROM recolhas WHERE  STATUS="A LANÇAR")
;';
