...
seguranca_adm();
$consulta = "SELECT * FROM mudanca WHERE concluido = 'NAO' ORDER BY ultima_alteracao DESC ; ";
...
$interval = $data1->diff($data2);
    ?>
      ...
      <tr>
        ...
        <td style="vertical-align: middle;"><strong><?php echo $nome ?></strong><br><?php
...
echo $x;
?>
          , Nº <?php echo $numero ?> - <?php echo $bairro ?> <a href="https://app.xgstelecom.com.br/os/mudancas.php?id=<?php echo $linha['id_cliente']; ?>"  target="_blank" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe-americas" viewBox="0 0 16 16">
...
*ANTIGO ENDEREÇO: :* 
<?php echo $linha['rua']; ?>, Nº <?php echo $linha['numero']; ?> - <?php echo $linha['bairro']; ?>  
*NOVO ENDEREÇO: :* 
<?php echo $linha['rua2']; ?>, Nº <?php echo $linha['numero2']; ?> - <?php echo $linha['bairro2']; ?> 
