...
$dataLocal = date('d/m/Y H:i:s', time());
    ...
    $qtd_formatada = str_replace(',', '.', str_replace('.', '', $quantidade_entrada));
    $data_cadastro = date('Y-m-d H:i:s');
    $alterado_por = $_SESSION['usuarioNome'];
    

    $query = "UPDATE hb_estoque_frenteloja set quantidade = quantidade + '$qtd_formatada' WHERE  produto ='$produto_entrada'";
    $log_categoria = "INSERT INTO hb_logs_estoque_frenteloja set log='ADICIONOU $qtd_formatada $produto_entrada NO ESTOQUE!', motivo='$motivo', tecnico='$tecnico',  data='$data_cadastro', utilizador='$alterado_por'";
    ...
    $_SESSION['toast_msg'] = '<div class="toast show fade text-bg-success p-3" role="alert" aria-live="assertive" aria-atomic="true" data-mdb-toast-init="" data-mdb-color="success" data-mdb-autohide="false" data-mdb-toast-initialized="true">
            ...
            <div class="toast-body"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">ENTRADA CADASTRADA COM SUCESSO!.</font></font></div>
          </div>';
