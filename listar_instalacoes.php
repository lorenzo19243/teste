...
<table class="table table-striped table-sm" style="font-size: 14px;">
    <thead class="bg-dark text text-white">
      <tr >
               <th scope="col" style="border:none" width="2%"><div class="fs-6 badge d-flex text-light-emphasis bg-light-subtle"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-ui-checks" viewBox="0 0 16 16">
...
<?php 
$consulta = 'SELECT * FROM instalacoes WHERE  STATUS="ANDAMENTO" ORDER BY ultima_alteracao';
...
$interval = $data1->diff($data2);
    ...
    ?>
      ...
      <tr>
        ...
        <td><span style="font-weight: bold;"><?php echo $nome = mb_strtoupper($nome); ?> </span><br> CPF: <?php echo $cpf ?> - <a href="pdf/contrato.php?id_cliente=<?php echo $linha['id_cliente']; ?> " target="_blank"><span class="start-100 badge text-bg-primary rounded-pill">CONTRATO</span></a> <a href="https://app.xgstelecom.com.br/os/instalacoes.php?id=<?php echo $linha['id_cliente']; ?>"  target="_blank" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe-americas" viewBox="0 0 16 16">
  <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0M2.04 4.326c.325 1.329 2.532 2.54 3.717 3.19.48.263.793.434.743.484q-.121.12-.242.234c-.416.396-.787.749-.758 1.266.035.634.618.824 1.214 1.017.577.188 1.168.38 1.286.983.082.417-.075.988-.22 1.52-.215.782-.406 1.48.22 1.48 1.5-.5 3.798-3.186 4-5 .138-1.243-2-2-3.5-2.5-.478-.16-.755.081-.99.284-.172.15-.322.279-.51.216-.445-.148-2.5-2-1.5-2.5.78-.39.952-.171 1.227.182.078.099.163.208.273.318.609.304.662-.132.723-.633.039-.322.081-.671.277-.867.434-.434 1.265-.791 2.028-1.12.712-.306 1.365-.587 1.579-.88A7 7 0 1 1 2.04 4.327Z"/>
</svg></a></td>
        <td><?php echo $rua ?>, Nº <?php echo $numero ?><br><?php echo $bairro ?>
          <?php
...
?></td>
        <td style="text-align: center; vertical-align: middle;"><h5><span class="badge text-bg-secondary border-0 rounded-pill p-1"><?php echo date('d/m/y',  strtotime($agendado));?></span><br></h5></td>
...
<strong>RUA:</strong> <?php echo $rua ?> - Nº <?php echo $numero ?><br>
...
<strong>ALTERADO POR:</strong> <?php echo $alterado_por ?> - <?php echo $ultima_alteracao = date('d/m/Y H:i:s',  strtotime($ultima_alteracao));?> <br>
        ...
        <td style="vertical-align: middle;"><a class="accordion-button" href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#editarCliente" data-whatever="<?php echo $linha['id_cliente']; ?>" 
...
data-whateverhorario="<?php echo $horario ?>"
...
<?php 
$consulta = 'SELECT * FROM instalacoes WHERE  STATUS="REMARCAR" ORDER BY agendado';
$resultado = mysqli_query($conn, $consulta);
 ?>
    <tbody>
    <?php
...
?></td>
        <td style="text-align: center; vertical-align: middle;"><h5><span class="badge text-bg-secondary border-0 rounded-pill p-1"><?php echo date('d/m/y',  strtotime($agendado));?></span><br><?php
$horario = $horario;
...
{
$z = '<span class="badge bg-dark-subtle border border-dark-subtle text-dark-emphasis rounded-pill p-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-stopwatch" viewBox="1 2 16 16">
  <path d="M8.5 5.6a.5.5 0 1 0-1 0v2.9h-3a.5.5 0 0 0 0 1H8a.5.5 0 0 0 .5-.5z"/>
  <path d="M6.5 1A.5.5 0 0 1 7 .5h2a.5.5 0 0 1 0 1v.57c1.36.196 2.594.78 3.584 1.64l.012-.013.354-.354-.354-.353a.5.5 0 0 1 .707-.708l1.414 1.415a.5.5 0 1 1-.707.707l-.353-.354-.354.354-.013.012A7 7 0 1 1 7 2.071V1.5a.5.5 0 0 1-.5-.5M8 3a6 6 0 1 0 .001 12A6 6 0 0 0 8 3"/>
</svg> '.date('H:s',  strtotime($horario)).'</span>';
}
...
<?php 
$consulta = 'SELECT * FROM instalacoes WHERE  STATUS="A LANÇAR" ORDER BY agendado';
$resultado = mysqli_query($conn, $consulta);
 ?>
    <tbody>
    <?php
      ...
      <form method="POST" action="processa_cad_instalacoes.php">
        <div class="row">
          <div class="col-md-8 col-sm-12">
            ...
            <input oninput="this.value = this.value.toUpperCase()" type="text" name="nome" id="nome" maxlength="50" class="form-control">
          </div>
          <div class="col-md-4 col-sm-12">
             <label for="recipient-cpf" class="col-form-label">CPF:</label>
            <input class="w3-input w3-border form-control "  type="text"  name="cpf" >
          </div>
        </div>
        <div class="row">
          <div class="col-md-9 col-sm-12">
            <label oninput="this.value = this.value.toUpperCase()" for="recipient-observacao" class="col-form-label">OBSERVAÇÃO:</label>
            <textarea style="text-transform: uppercase;" class="form-control" name="observacao" id="recipient-observacao"  aria-label="With textarea"></textarea>
          </div>
           <div class="col-md-3 col-sm-12">
            <label for="recipient-numero" class="col-form-label">PLANO</label>
            :
            <select class="form-select" name="plano" id="plano" aria-label=".form-select-lg example">
          ...
          <div class="col-md-5 col-sm-12">
            ...
            <input type="text" value="-43" name="longitude" id="longitude" maxlength="50" class="form-control">
          </div>
          <div class="col-md-5 col-sm-12">
            <label for="recipient-bairro" class="col-form-label">LATITUDE:</label>
            <input type="text" value="-12" name="latitude" id="latitude" maxlength="50" class="form-control">
          </div>
          <div class="col-md-5 col-sm-12">
            ...
            <select class="form-select" aria-label="Default select example" name="bairro" id="bairro">
              ...
              <option value="VALE DO AMANHECER">VALE DO AMANHECER</option>
          ...
          <div class="col-md-5 col-sm-12">
            ...
            <input oninput="this.value = this.value.toUpperCase()" type="text" name="rua" id="rua" maxlength="50" class="form-control -10">
          </div>
        ...
        <div class="row mb-4">
          <div class="col-md-3 col-sm-12">
            ...
            <input class="form-control "  type="date"  name="agendado" id="agendado" value="<?php echo date("Y-m-d") ?>">
          </div>
          <div class="col-md-2 col-sm-12">
            <label for="recipient-horario" class="col-form-label">HORARIO?:</label>
            <input class="form-control "  type="time"  name="horario" id="recipient-horario">
          </div>
          ...
          <div class="col-md-2 col-sm-12">
            <label for="recipient-dataCadastro" class="col-form-label">CADASTRADO:</label>
...
<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form method="POST" action="processa_edit_instalacoes.php" enctype="multipart/form-data">
        <div class="row">
...
<select multiple="multiple" id="recipient-tecnicos" name="tecnico[]" class="selectpicker form-control" aria-label="size 3 select example" >
    <?php
$hoje = date("Y-m-d");
...
<?php
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-12">
            ...
            <input type="text" name="pppoe" id="recipient-pppoe" maxlength="50" class="form-control -10">
          </div>
          <div class="col-md-3 col-sm-12">
...
?>
        ...
        <input type="text" class="form-control" name="timer_quantidade_saida" value="">
          ...
          <div class="col-md-2 col-sm-12">
            <label for="recipient-repetidor" class="col-form-label">REPETIDOR</label>
          ...
          <div class="col-md-2 col-sm-12">
            <label for="recipient-repetidor" class="col-form-label">DROP SOLTO:</label>
          ...
          <div class="col-md-2 col-sm-12">
            <label for="recipient-prensa" class="col-form-label">P/ FIO:</label>
            <input type="text" name="prensa" id="recipient-prensa" maxlength="50" class="form-control -10">
          </div>
          <div class="col-md-2 col-sm-12">
          ...
          <div class="col-md-2 col-sm-12">
           ...
           <div class="col-md-3 col-sm-10">
            <label for="recipient-rua" class="col-form-label">REDE WIFI:</label>
            <input type="text" name="rede" id="rede" maxlength="50" class="form-control -10">
          </div>
          <div class="col-md-3 col-sm-12">
            <label for="recipient-rua" class="col-form-label">SENHA WIFI:</label>
