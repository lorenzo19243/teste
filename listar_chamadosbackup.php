...
seguranca_adm();
$consulta = 'SELECT * FROM clientes WHERE STATUS="ANDAMENTO"   
union 
(SELECT * FROM clientes WHERE STATUS="REMARCAR" )
union
(SELECT * FROM clientes WHERE STATUS="A LANÇAR" ORDER BY data_cadastro DESC, status ) ';
