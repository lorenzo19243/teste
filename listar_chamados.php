...
<?php
$consulta = 'SELECT * FROM clientes WHERE STATUS="ANDAMENTO" ORDER BY ultima_alteracao';
...
<table class="table table-striped table-sm" style="font-size: 14px;" align="center">
  ...
  <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5m.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1z"/>
        ...
        <th scope="col" style="border:none" width="18%"><div class="fs-6 badge d-flex text-light-emphasis bg-light-subtle"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-octagon-fill" viewBox="0 0 16 16">
...
if ($situacao == 'CLIENTE SEM ACESSO')
{
$x = "class='table-danger'";
}
else
{
$x = "";
...
echo $x;
?>
</td>   <td style="text-align: center; vertical-align: middle;"><h5><span class="badge text-bg-secondary  rounded-pill p-1"><?php echo date('d/m/y',  strtotime($agendado));?></span><br>
...
<?php
$consulta = 'SELECT * FROM clientes WHERE STATUS="REMARCAR" ORDER BY ultima_alteracao';
$resultado = mysqli_query($conn, $consulta);
?>
    <?php
...
echo $x;
?>
</td>   <td style="text-align: center; vertical-align: middle;"><h5><span class="badge text-bg-secondary  rounded-pill p-1"><?php echo date('d/m/y',  strtotime($agendado));?></span><br><?php
$horario = $horario;
...
data-whateveralterado_por="<?php echo $alterado_por; ?>" 
data-whateveragendado="<?php echo $agendado;?>"
data-whateveragendado="<?php echo $horario;?>"
data-whateverultima_alteracao="<?php echo $ultima_alteracao = date('d/m/Y H:i:s',  strtotime($ultima_alteracao));?>"><svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-edit"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1" /><path d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z" /><path d="M16 5l3 3" /></svg></a>
<?php 
                        if($_SESSION['perfil_cod'] == 1){
                    ?>
...
?>
 ...
 <?php
$consulta = 'SELECT * FROM clientes WHERE STATUS="A LANÇAR" ORDER BY agendado';
$resultado = mysqli_query($conn, $consulta);
?>
    <?php
$contar = mysqli_num_rows($resultado);
...
<?php
        ...
        <div class="row">
          <div class="col-md-10 col-sm-12">
            ...
            <textarea style="text-transform: uppercase;" class="form-control" name="conclusao" id="recipient-conclusao"  aria-label="With textarea"></textarea>
          </div>
          <div class="col-md-2 col-sm-12">
...
?>
       ...
       <div class="col-md-1">
        ...
        <input type="text" class="form-control" value="0" name="roteador_quantidade_saida" value="">
      </div>
          <div class="col-md-3 col-sm-12">
...
?>
                   ...
                   <div class="col-md-1">
        <label for="exampleFormControlInput1" name="email"  class="col-form-label">QTD:</label>
        <input type="text" class="form-control" value="0" name="timer_quantidade_saida" value="">
      </div>
                <div class="col-md-2 col-sm-12">
            <label for="recipient-prensa" class="col-form-label">P/ FIO:</label>
            <input type="text" name="prensa"  value="0" id="recipient-prensa" maxlength="50" class="form-control -10">
          </div>
          <div class="col-md-2 col-sm-12">
          ...
          <div class="col-md-2 col-sm-12">
            ...
            <input type="text" name="esticador" value="0" id="esticador" maxlength="50" class="form-control -10">
          </div>
          <div class="col-md-2 col-sm-12">
            <label for="recipient-rua" class="col-form-label">BUXA/PARAF.:</label>
            <input type="text" name="buxa_parafuso" value="0" id="busxa_parafuso" maxlength="50" class="form-control -10">
          </div>
                     <div class="col-md-2 col-sm-12">
            <label for="recipient-drop" class="col-form-label">DROP:</label>
            <input type="text" name="cabo_drop" value="0" id="cabo_drop" maxlength="50" class="form-control -10">
          </div>
          <div class="col-md-2 col-sm-12">
