...
<?php 
                    ...
                    ?><a class="btn btn-primary me-md-2"  href="add_produto_geral.php">ADD NOVO PRODUTO</a><?php } ?>
</div>
 </div>      
...
<div class="row mb-2">
                                     <?php
$consulta = "SELECT * FROM hb_estoque_geral ORDER BY produto";
              ...
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">ENTRADA DE ESTOQUE<strong>
                       <form method="POST" action="add_entrada_estoque_geral.php" enctype="multipart/form-data">                     
                       <div class="row">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">SAIDA DE ESTOQUE<strong>
                       <form method="POST" action="add_saida_estoque_geral.php" enctype="multipart/form-data">                     
                       <div class="row">
 <div class="col-md-6 col-sm-12">
          <label for="recipient-urgente" class="col-form-label">PRODUTO:</label>
