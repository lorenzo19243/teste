...
echo '<form method="POST" action="processa_cad_tvbox.php">
        <div class="row">
          ...
          <div class="col-md-5 col-sm-5">
            ...
            <select class="form-control form-select" name="situacao" id="situacao" >
              <option value="VERIFICAR TVBOX">VERIFICAR TVBOX</option>
              <option value="INSTALACAO TVBOX">INSTALAÇÃO TVBOX</option>
              <option value="RECOLHA TVBOX">RECOLHA TVBOX</option>
            </select>
          </div>
        </div>
        <div class="row">
