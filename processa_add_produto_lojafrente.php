...
$altera_cliente = "INSERT INTO hb_estoque_frenteloja SET produto='$produto', quantidade='$qtd_formatada', data='$data_cadastro'";
$log_categoria = "INSERT INTO hb_logs_estoque_lojafrente set log='CADASTROU $produto NO ESTOQUE', data='$data_cadastro', utilizador='$utilizador'";
