...
$id_cameras = mysqli_real_escape_string($conn, $_GET['id_cameras']);
$nome = mysqli_real_escape_string($conn, $_GET['nome']);
$ultima_alteracao = date('Y-m-d H:i:s');
$alterado_por = $_SESSION['usuarioNome'];

$altera_cliente = "DELETE FROM cameras WHERE id_cameras='$id_cameras'";
$log_categoria = "INSERT INTO hb_os_logs set log='DELETOU O AGENDAMENTO REPARO DE $nome', data='$ultima_alteracao', utilizador='$alterado_por'";
