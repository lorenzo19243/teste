...
$altera_cliente = "DELETE FROM hb_estoque WHERE id='$id'";
$log_categoria = "INSERT INTO hb_os_logs set log='DELETOU $produto DO ESTOQUE', data='$ultima_alteracao', utilizador='$alterado_por'";
