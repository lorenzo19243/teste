...
$busca = "SELECT * FROM instalacoes WHERE nome LIKE '%$pesquisar%' OR bairro LIKE '%$pesquisar%' ORDER BY concluido='NAO' DESC";
...
<header class="p-3 text-bg-dark">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <li class="nav-link">
<a class="btn btn-warning position-relative btn-sm"  href="instalacoes">INSTALACOES <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-check" viewBox="0 0 16 16">
...
<li class="nav-link">
<button type="button" class="btn btn-warning position-relative btn-sm" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#cadCliente">NOVA INSTALAÇÃO <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
...
<select multiple="multiple" id="recipient-tecnicos" name="tecnico[]" class="selectpicker form-control" aria-label="size 3 select example" required>
    <?php
$hoje = date("Y-m-d");
