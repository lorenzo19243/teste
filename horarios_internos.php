...
<main class="container">
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    ...
    $query_usuarios = "SELECT id, tecnicos, semana  FROM horarios WHERE local='INTERNO'";
    ...
    echo "<form method='POST' action='form_edit_horarios_int.php'>";
