...
$altera_cliente = "INSERT INTO hb_estoque_geral SET produto='$produto', quantidade='$qtd_formatada', data='$data_cadastro'";
$log_categoria = "INSERT INTO hb_logs_estoque_geral set log='CADASTROU $produto NO ESTOQUE GERAL', data='$data_cadastro', utilizador='$utilizador'";
