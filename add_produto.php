...
<main class="container">
  ...
  <div class="bg-body-tertiary p-5 rounded mt-3"> 
    <form method="POST" enctype="multipart/form-data" action="processa_add_produto.php">
      <div class="row">
      <div class="col-md-4">
      ...
      <div class="col-md-2">
        ...
        <input type="text" class="form-control" name="quantidade" value="">
          ...
          <div class="col-md-2">
            <label for="recipient-veiculo" class="col-form-label">TIPO:</label>
            <select class="form-select" name="tipo" id="recipient-veiculo" aria-label=".form-select-lg example">
