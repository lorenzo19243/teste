...
?>
    ...
    if (!empty($dados['tecnicos'])) {
        ...
        $query_usuarios = "SELECT id, tecnicos, ordem
                    FROM horarios 
        ...
        echo "<form method='POST' action='processa_edit_horarios.php'>";
        ...
        while ($row_usuario = $result_usuarios->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "HORARIO: <input type='text' name='ordem[]' value='$ordem' placeholder=''><br><br>";
            echo "<hr>";
        }
        ...
        header("Location: horarios_externos.php");
    }
    ?>
