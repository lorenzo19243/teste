...
$dataLocal = date('d/m/Y H:i:s', time());
    ...
    $query = "UPDATE hb_estoque set quantidade = quantidade + '$qtd_formatada' WHERE  produto ='$produto_entrada'";
    $log_categoria = "INSERT INTO hb_os_logs set log='ADICIONOU $qtd_formatada $produto_entrada NO ESTOQUE! - $motivo', data='$data_cadastro', utilizador='$alterado_por'";
