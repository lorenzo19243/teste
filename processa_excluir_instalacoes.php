...
$altera_cliente = "DELETE FROM instalacoes WHERE id_cliente='$id_cliente'";
$log_categoria = "INSERT INTO hb_os_logs set log='DELETOU O AGENDAMENTO INSTALAÇÃO DE $nome', data='$ultima_alteracao', utilizador='$alterado_por'";
...
if($resposta){
    ...
    $_SESSION['toast_msg'] = "<div class='alert alert-danger alert-dismissible fade show text text-center mb-0' role='alert'>
                                ...
                                <strong> NÃO FOI POSSÍVEL EXCLUIR O CLIENTE &nbsp; <i class='fas fa-grin-squint-tears fa-2x'></i> </strong> 
                                   <i class='far fa-smile-wink fa-2x'></i> </strong> 
