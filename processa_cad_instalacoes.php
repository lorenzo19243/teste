...
$horario = mysqli_real_escape_string($conn, $_POST['horario']);
    ...
    $link = mysqli_query($conn, "SELECT nome FROM instalacoes WHERE nome = '$nome' AND  STATUS in ('A LANÇAR','REMARCAR','ANDAMENTO') ");
...
$altera_cliente = "INSERT INTO `instalacoes`(`nome`, `observacao`, `rua`, `numero`, `bairro`, `plano`, `criado_por`, `alterado_por`, `status`, `veiculo`, `tecnico`, `concluido`, `data_cadastro`, `ultima_alteracao`, `data_fim`, `agendado`, `cpf` , `latitude`, `longitude`, `horario`) VALUES ('$nome','$observacao','$rua','$numero','$bairro','$plano','$criado_por','$alterado_por','$status','$veiculo','$tecnico','$concluido','$data_cadastro','$ultima_alteracao','$data_fim','$agendado','$cpf','$latitude','$longitude','$horario')";
$log_categoria = "INSERT INTO hb_os_logs set log='AGENDOU A INSTALAÇÃO DE $nome', data='$data_cadastro', utilizador='$criado_por'";
