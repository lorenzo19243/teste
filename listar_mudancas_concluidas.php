...
seguranca_adm();
$consulta = "SELECT * FROM mudanca WHERE concluido = 'SIM' ORDER BY ultima_alteracao DESC ; ";
...
<header class="p-3 text-bg-dark">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <ul class="navbar-nav">
        <li class="nav-link">
<a class="btn btn-warning position-relative btn-sm"  href="mudancas">LISTAR <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-check" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5M3.854 2.146a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 3.293l1.146-1.147a.5.5 0 0 1 .708 0m0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 7.293l1.146-1.147a.5.5 0 0 1 .708 0m0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 0 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0"/>
</svg></a> <a class="btn btn-warning position-relative btn-sm"  href="mudancas_concluidas">CONCLUIDAS <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2-circle" viewBox="0 0 16 16">
...
<div class="col-md-4 justify-content-end">
        <form class="row g-5" role="search"  method="POST" action="pesquisar_mudancas.php">
...
<table class="table table-striped table-sm" style="font-size: 14px;">
    ...
    <tr>
                <th scope="col" style="border:none" width="4%"><div class="fs-6 badge d-flex text-light-emphasis bg-light-subtle"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-ui-checks" viewBox="0 0 16 16">
...
function showReport(){
include('config/conexao.php');
    $r = mysqli_query($conn,'SELECT DISTINCT data_fim FROM mudanca WHERE concluido ="SIM"  ORDER BY data_fim DESC');
    echo '<tbody>';
    ...
    if($r >= null){ 
        ...
        while($reg = mysqli_fetch_assoc($r)){
			...
			echo '<tr class="table-dark text text-white" style="border:none">
				...
				$clientes = mysqli_query($conn,'SELECT * FROM mudanca WHERE data_fim = "'. $reg['data_fim'] .'" and concluido="SIM"');
				
				$row_cnt = mysqli_num_rows($clientes);

printf(" - %d MUDANÇAS CONCLUIDAS.</strong>\n", $row_cnt);
  			
            $result = mysqli_query($conn,'SELECT * FROM mudanca WHERE data_fim = "'. $reg['data_fim'] .'" and concluido="SIM" ORDER BY ultima_alteracao DESC');
            if($result != null){
                echo '</td>
                <td style="border:none"></td>
                <td style="border:none"></td>
...
$interval = $data1->diff($data2);
                   ...
                   <tr>
                   <td style="vertical-align: middle;"><?php echo $id_cliente ?> </td>
                   <td style="font-weight: bold; vertical-align: middle;"><?php echo $nome ?> </td>
...
<td style="text-align: center; vertical-align: middle;">
	...
	<td style="text-align: center; vertical-align: middle;"><button type="button" class="copy border border-0" data-clipboard-text="
*ORDEM DE SERVIÇO Nº <?php echo $linha['id_cliente']?>* 

*STATUS:* MUDANÇA CONCLUIDA  
...
echo $j;
?> 
*SITUAÇÃO:* <?php echo $linha['conclusao']?> 
      ...
      <form method="POST" action="processa_cad_mudancas.php">
        ...
        <div class="row">
          <div class="col-md-5 col-sm-12">
            ...
            :
            <select class="form-control form-select-lg mb-5 select2" aria-label="Default select example" name="bairro2" id="bairro2">
              <option selected>SELECIONE O BAIRRO</option>
              <option value="ALDEIA KIRIRI">ALDEIA KIRIRI</option>
              <option value="ALDEIA TUXA">ALDEIA TUXA</option>
              <option value="ALDEIA TUXA RIACHO SERRA BRANCA">ALDEIA TUXA RIACHO SERRA BRANCA</option>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12">
                            <label for="recipient-bairro" class="col-form-label">NOVO BAIRRO</label>
                            <input type="text" name="bairro" id="recipient-bairro" maxlength="50" class="form-control" disabled>
                        </div>
                        <div class="col-md-5 col-sm-12">
                            <label for="recipient-rua" class="col-form-label">NOVA RUA</label>
                            <input type="text" name="rua" id="recipient-rua" maxlength="50" class="form-control -10" disabled>
                        </div>
                        <div class="col-md-2 col-sm-12">
                            <label for="recipient-numero" class="col-form-label">NOVO N°</label>
...
<?php
        ...
        <div class="row">
          ...
          <div class="col-md-2 col-sm-12">
            ...
            <select class="form-control form-select" name="repetidor" id="repetidor" aria-label=".form-select-lg example">
              <option value="NAO">NAO</option>
