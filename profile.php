...
?>
    <form method="POST" enctype="multipart/form-data" action="processa_edit_usuarios.php?id=<?php echo $x['id']; ?>">
...
?></div>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="email" value="<?php echo $x['email']?>">
      </div>
      <div class="mb-3">
        <label for="exampleFormControlInput1" name="email" class="form-label">DATA NASCIMENTO</label>
        <input type="date" class="form-control" name="nasc" value="<?php echo $x['nasc']?>">
      </div>
      <div class="mb-3">
        <label for="exampleFormControlInput1" name="email" class="form-label">TELEFONE</label>
        <input type="text" class="form-control" name="fone" value="<?php echo $x['fone']?>">
      </div>
      ...
      <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">TROCAR FOTO ?  -  
        
         <input name="nova_imagem" type="radio" value="sim" /> SIM
                                     <input name="imagem_antiga" type="hidden" value="<?php echo $x['foto']?>" />
                                         </label>
                                         <label class="checkbox inline">
                                     <input name="nova_imagem" type="radio" value="nao" checked="checked"/> NAO
