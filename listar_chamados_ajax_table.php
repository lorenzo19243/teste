...
union
(SELECT * FROM clientes WHERE STATUS="A LANÇAR" ORDER BY ultima_alteracao DESC, status ) ';
...
echo $x;
?>
</td>   <td style="text-align: center; vertical-align: middle;"><h5><span class="badge text-bg-secondary border-0 rounded-pill p-1"><?php echo date('d/m/y',  strtotime($agendado));?></span></h5></td>
