...
$altera_cliente = "INSERT INTO folgas (tecnico, data) 
VALUES ('$tecnico', '$data')";
$log_categoria = "INSERT INTO hb_os_logs set log='AGENDOU A FOLGA DE $tecnico', data='$data_cadastro', utilizador='$criado_por'";
