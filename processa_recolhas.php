...
foreach ($retorno4['registros'] as $registro) {
	...
	$descricao_aux_plano_venda = $registro['descricao_aux_plano_venda'];
...
echo'
<form method="POST" action="processa_cad_recolhas.php">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <input type="text" name="observacao" id="observacao" maxlength="200" class="form-control" value="'.$descricao_aux_plano_venda.'">
                        </div>
...
<div class="row">
 ...
 <div class="col-md-4 col-sm-12">
                          <label for="recipient-agendado" class="col-form-label">RECOLHER DIA:</label>
