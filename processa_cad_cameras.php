...
$altera_cliente = "INSERT INTO cameras (nome, situacao, observacao, atendente, tecnico, rua, numero, bairro, data_cadastro, criado_por, status, sinal, pppoe, plano, rede, redesenha, concluido, agendado, latitude, longitude) 
VALUES ('$nome', '$situacao', '$observacao', '$atendente', '$tecnico', '$rua', '$numero', '$bairro', '$data_cadastro', '$criado_por', '$status', '$sinal', '$pppoe', '$plano', '$rede', '$redesenha', '$concluido' , '$agendado','$latitude','$longitude')";
$log_categoria = "INSERT INTO hb_os_logs set log='AGENDOU $situacao, DE $nome ', data='$data_cadastro', utilizador='$alterado_por'";
