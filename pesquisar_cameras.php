...
$busca = "SELECT * FROM cameras WHERE nome LIKE '%$pesquisar%' OR bairro LIKE '%$pesquisar%' ORDER BY concluido='NAO' DESC";
...
<header class="p-3 text-bg-dark">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <li class="nav-link">
<a class="btn btn-warning position-relative btn-sm"  href="cameras">CHAMADOS <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-check" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5M3.854 2.146a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 3.293l1.146-1.147a.5.5 0 0 1 .708 0m0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 7.293l1.146-1.147a.5.5 0 0 1 .708 0m0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 0 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0"/>
</svg></a> </li> <li class="nav-link"><a class="btn btn-warning position-relative btn-sm"  href="cameras_concluidas">CONCLUIDOS <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2-circle" viewBox="0 0 16 16">
...
<div class="col-md-4 justify-content-between p-3">
        <form class="row g-5" role="search" method="POST" action="pesquisar_cameras.php">
...
{ echo'<table class="table table-striped table-sm" style="font-size: 14px;">
    <thead class="bg-dark text text-white">
      <tr>
        ...
        <th scope="col" style="border:none" width="16%">SITUAÇÃO</th>
...
if ($observacao >= '0') {
    $os = "<button type='button' class='badge rounded-pill text-bg-warning border-0' data-toggle='modal' data-target='#modal$id_cameras'>
OBS!
</button>";
} else {
    $os = "";
...
?></td>
        ...
        <td class="text text-center"><a class="accordion-button" href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#visulaizarCliente" data-whatever="<?php echo $linha['id_cameras']; ?>" data-whatevernome="<?php echo $linha['nome']; ?>" 
    ...
    data-whateverobservacao="<?php echo $linha['observacao']; ?>"   
     data-whateverveiculo="<?php echo $linha['sinal']; ?>"      data-whateverplano="<?php echo $linha['plano']; ?>"                 
       ...
       data-whateverultima_alteracao="<?php echo $ultima_alteracao; ?>"> <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-browser-maximize"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 8h8" /><path d="M20 11.5v6.5a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h6.5" /><path d="M8 4v4" /><path d="M16 8l5 -5" /><path d="M21 7.5v-4.5h-4.5" /></svg></a></td>
        <td class="text text-center"><a class="accordion-button" href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#editarCliente" data-whatever="<?php echo $linha['id_cameras']; ?>" 
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-12">
            ...
            <select class="form-control form-select" name="status" id="status" aria-label=".form-select-lg example">
              ...
              <option value="<button type='button' class='btn btn-success btn-sm' >reativou</button>">REATIVOU</option>
            </select>
          </div>
        </div>
        <div class="row">
