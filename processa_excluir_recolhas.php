...
$altera_cliente = "DELETE FROM recolhas WHERE id_cliente='$id_cliente'";
$log_categoria = "INSERT INTO hb_os_logs set log='DELETOU O AGENDAMENTO RECOLHA DE $nome', data='$ultima_alteracao', utilizador='$alterado_por'";
