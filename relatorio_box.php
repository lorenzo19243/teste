...
printf("%d REPAROS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM tvbox_chamados WHERE MONTH(data_fim)="9" AND situacao="VERIFICAR TVBOX" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d REPARO", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM tvbox_chamados WHERE MONTH(data_fim)="10" AND situacao="VERIFICAR TVBOX" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d REPAROS", $row_cnt);				
 ?></td>
      <td> <?php $clientes = mysqli_query($conn,'SELECT * FROM tvbox_chamados WHERE YEAR(data_fim)="2024" AND concluido="SIM" AND situacao="VERIFICAR TVBOX";');
...
<tr>
      <th scope="row">INSTALAÇÕES BOX</th>
...
printf("%d INSTAL.", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM tvbox_chamados WHERE MONTH(data_fim)="9" AND situacao="INSTALACAO TVBOX" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d INSTAL.", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM tvbox_chamados WHERE MONTH(data_fim)="10" AND situacao="INSTALACAO TVBOX" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d INSTAL.", $row_cnt);				
 ?></td>
      <td> <?php $clientes = mysqli_query($conn,'SELECT * FROM tvbox_chamados WHERE YEAR(data_fim)="2024" AND concluido="SIM" AND situacao="INSTALACAO TVBOX";');
...
printf("%d MUDANÇAS", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM tvbox_chamados WHERE MONTH(data_fim)="9" AND situacao="RECOLHA TVBOX" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d RECOLHA", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM tvbox_chamados WHERE MONTH(data_fim)="10" AND situacao="RECOLHA TVBOX" AND concluido="SIM" ORDER BY nome DESC;');
				
$row_cnt = mysqli_num_rows($clientes);

printf("%d RECOLHA", $row_cnt);				
 ?></td>
      <td><?php $clientes = mysqli_query($conn,'SELECT * FROM tvbox_chamados WHERE MONTH(data_fim)="11" AND situacao="RECOLHA TVBOX" AND concluido="SIM" ORDER BY nome DESC;');
...
printf("%d MUDANÇAS", $row_cnt);				
 ?></td>
      <td> <?php $clientes = mysqli_query($conn,'SELECT * FROM tvbox_chamados WHERE YEAR(data_fim)="2024" AND concluido="SIM" AND situacao="RECOLHA TVBOX";');
